...
//         return (
//             <form id="player-search" onSubmit={this.handleSubmit} className={this.props.class}>
//                 <label className="form-label" htmlFor={searchName}>Player One</label>
//                 <label className="form-label" htmlFor={searchName}>Player Two</label>
//                 <div className="row">
//                     <div className="col-8">
//                         <SearchBar value={this.state.value} handleChange={this.handleChange} autoComplete={this.autoComplete} searchName={searchName} data={this.state.data} />
//                     </div>
//                     <div className="col">
//                         <button type="submit" className="btn btn-primary">Search</button>
//                     </div>
